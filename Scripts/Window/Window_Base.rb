...
class Window_Base < Window
  ...
  def initialize(x, y, width, height)
    super
    self.windowskin = Cache.system(SKIN01)
    update_padding
    update_tone
    create_contents
  ...
  def mp_cost_color;     text_color(23);  end;    # MP cost
  ...
  def sp_gauge_color1;   text_color(28);  end;    # SP gauge 1
  def sp_gauge_color2;   text_color(29);  end;    # SP gauge 2
  def sp_cost_color;     text_color(29);  end;    # SP cost
  def new_item_color;    text_color(17);  end;    # New item color
  #--------------------------------------------------------------------------
...
#~   end
  ...
  def draw_actor_sp(actor, x, y, width = 124)
    ...
    change_color(system_color)
    draw_text(x, y, 30, line_height, Vocab::SP)
  ...
  def draw_actor_param(actor, x, y, param_id)
    ...
    change_color(normal_color)
    draw_text(x + 120, y, 48, line_height, actor.param(param_id), Bitmap::ALIGN_RIGHT)
  end
  #--------------------------------------------------------------------------
  # * Modified
  # * Draw Item Name
